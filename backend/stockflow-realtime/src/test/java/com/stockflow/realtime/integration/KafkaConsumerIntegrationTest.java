...
@EmbeddedKafka(
    partitions = 1,
    topics = {"market.normalized", "market.dlq"},
    brokerProperties = {
...
class KafkaConsumerIntegrationTest {
    ...
    private static final String DLQ_TOPIC_NAME = "market.dlq";
    ...
    void setUp() {
        ...
        DefaultKafkaProducerFactory<String, NormalizedTradeDTO> producerFactory =
    ...
    void tearDown() {
        ...
        if (producerTemplate != null) {
            producerTemplate.getProducerFactory().destroy();
        }
    }
    ...
    void testProduceAndConsume() {
        ...
        assertEquals(trade.getQuantity(), record.value().getQuantity());
